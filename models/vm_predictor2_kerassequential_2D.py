''' 
vm_predictor2_kerassequential_2D.py

This script builds and trains an ANN using the Keras sequential API to predict the von Mises stress distribution on a specified cross-section of the geometry.

'''

STRESS_FILE_DIRECTORY = "C:/Users/ed_ba/OneDrive - The University of Manchester/Year 3/Project/finite_element_data/split_files_2D/"
...
def final_model_performance(model, test_set, y_mean, y_std, hyperparameters, start_time, training_start_time, training_end_time):
    ...
    # RMSE percentage for the validation set
    rmse_percentage = format(rmse / y_mean * 1e8, '.4f')
...
log_dir = "C:/Users/ed_ba/Documents/Project/keras_models/logs/" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
...
# model = tf.keras.models.load_model('2D_kerassequential.h5', custom_objects={'mish': mish})

project_name = "random_search_2D"
...
# model.save(f'2D_kerassequential.h5')
